...
public final class OpenWeatherJsonUtils {
    ...
    private static final String MAIN_DETAILS = "main";
...
//        long normalizedUtcStartDay = SunshineDateUtils.normalizeDate(now);
        ...
        for (int i = 0; i < jsonWeatherArray.length(); i++) {
            ...
            JSONObject mainDetails = dayForecast.getJSONObject(MAIN_DETAILS);
            JSONObject windDetails = dayForecast.getJSONObject(OWM_WIND);
            ...
            pressure = mainDetails.getDouble(OWM_PRESSURE);
            humidity = mainDetails.getInt(OWM_HUMIDITY);
            windSpeed = windDetails.getDouble(OWM_WINDSPEED);
            windDirection = windDetails.getDouble(OWM_WIND_DIRECTION);
             ...
             */
            high = mainDetails.getDouble(OWM_MAX);
            low = mainDetails.getDouble(OWM_MIN);
